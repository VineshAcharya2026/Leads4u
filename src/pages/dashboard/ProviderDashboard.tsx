      ...
      <div className="bg-[#1a3c6e] text-white py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            <Button variant="outline" className="border-white text-white hover:bg-white/10 rounded-xl font-bold">
              View Public Profile
            </Button>
            <Button className="bg-[#f97316] hover:bg-[#ea580c] text-white rounded-xl font-bold shadow-lg shadow-orange-900/20">
              Settings
            </Button>
          </div>
        </div>
