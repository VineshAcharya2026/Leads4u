...
import { Lead, LeadAssignment } from '../../types';
                  ...
                  <div className="p-8">
                    <div className="flex flex-col md:flex-row justify-between gap-8">
                      ...
                      <div className="flex flex-col justify-center gap-3 md:min-w-[180px]">
                        ...
                        <Button variant="ghost" className="text-slate-400 group-hover:text-slate-900 transition-colors flex items-center justify-center gap-1 text-sm font-bold">
