...
export function firebaseAuthMessage(error: unknown): string {
  ...
  switch (code) {
    case 'auth/operation-not-allowed':
      return 'Sign-in isn’t enabled for this app yet. In Firebase Console open Authentication → Sign-in method, then enable Email/Password and Google for project leads4u-946ef, save, and try again.';
